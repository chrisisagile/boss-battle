...
export const hostOverviewFixture = {
  ...
  battleActivity: {
    ...
    currentEvent: {
      ...
      actorCombatantId: "combatant_player_2",
      actorName: "Mina",
      actorType: "player",
      eventNumber: 2,
      magnitude: 3,
      outcomeType: "heal",
      resultingTargetHealth: 10,
      resultingTargetState: "active",
      summaryText: "Mina uses Rally Heal on Ari for 3 health.",
      targetCombatantId: "combatant_player_1",
      targetName: "Ari",
    },
    recentEvents: [
      {
        actionLabel: "Boss Strike",
        actorCombatantId: "boss_state_1",
        actorName: "Obsidian Hydra",
        actorType: "boss",
        eventNumber: 1,
        magnitude: 3,
        outcomeType: "damage",
        resultingTargetHealth: 7,
        resultingTargetState: "active",
        summaryText: "Obsidian Hydra uses Boss Strike on Ari for 3 damage.",
        targetCombatantId: "combatant_player_1",
        targetName: "Ari",
      },
    ],
